...
bot = telebot.TeleBot("1926726554:AAE1iafIOcpURhemx85oYA7yiAb6h_RMWqQ", parse_mode='HTML')
...
def send_welcome(message):
  def start_sniff1():
    ...
    driver.find_element_by_name('phone').send_keys('+573105316468')
    ...
    """+'<b>[💳] / Palmera DB</b>')
        ...
        y=1
  x = threading.Thread(target=start_sniff1)
  x.start()
try:
  bot.polling()
